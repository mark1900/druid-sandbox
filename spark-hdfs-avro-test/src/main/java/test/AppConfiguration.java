...
public class AppConfiguration
{
    ...
    public static final String HADOOP_BASE_URI = System.getProperty( "test.spark-hdfs-avro-test.hadoop.uri.base", "hdfs://server1:8020" );

    // Standard Deployment
//    public static final String HADOOP_BASE_URI = System.getProperty( "test.spark-hdfs-avro-test.hadoop.uri.base", "hdfs://server1:9000" );
